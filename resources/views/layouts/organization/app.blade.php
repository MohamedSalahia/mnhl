...
@include('layouts.organization._header')

@include('layouts.organization._aside')
...
<div class="app-content content ">
    ...
    @include('organization.partials._session')
...
<script>
    (function () {
        ...
        $(document).ready(function () {
            disableAutocomplete();
            // Also apply to AJAX-loaded modals and dynamic content
