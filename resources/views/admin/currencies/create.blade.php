                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('admin.currencies.store') }}" class="ajax-form">
                                @csrf
                                @method('post')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="decimal_places" class="form-control" value="{{ old('decimal_places') }}" required>
                                </div>
