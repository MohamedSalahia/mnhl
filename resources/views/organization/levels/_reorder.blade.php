<div class="row slide-lis" data-url="{{ route('organization.levels.reorder') }}">

    @forelse ($levels as $level)

        <div class="col-md-4 slide-item mb-1" id="{{ $level->id }}">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="d-flex justify-content-between align-items-start" style="overflow: hidden;">
                        <div class="flex-grow-1 text-center">
                            <h4 style="margin-bottom: 3px; font-size: 1rem; padding: 0.5rem; border-radius: 0.375rem;">{{ Str::limit($level->name, 30) }}</h4>
                        </div>
                    </div>
                </div>
