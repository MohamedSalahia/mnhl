                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <a href="{{ route('organization.admins.create') }}" wire:navigate class="btn btn-primary"><i data-feather="plus"></i> @lang('site.create')</a>
    ...
    <script>
        ...
        $(function () {
            ...
            let adminsTable = $('#admins-table').DataTable({
                ...
                ajax: {
                    url: '{{ route('organization.admins.data') }}',
                    data: function (d) {
                        d.role_id = role;
                        d.branch_id = branch;
                    }
