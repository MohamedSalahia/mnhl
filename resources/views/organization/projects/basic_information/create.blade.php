                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('organization.projects.basic_information.store') }}" class="ajax-form">
                                @csrf
                                @method('post')
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" name="can_proceed_to_next_project" class="custom-control-input" id="can_proceed_to_next_project" value="1">
