                                ...
                                <div class="col-md-12">
                                    ...
                                    @if (auth()->user()->hasPermission('create_levels', session('selected_branch')['id']))
                                        <a href="#" class="btn btn-primary ajax-modal"
                                           data-url="{{ route('organization.levels.create', ['project_id' => $project->id]) }}"
                                    ...
                                    @if (auth()->user()->hasPermission('update_levels', session('selected_branch')['id']))
                                        <a href="#" class="btn btn-primary ajax-modal"
                                           data-url="{{ route('organization.levels.reorder', ['project_id' => $project->id]) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group mt-1">
                                        <a href="{{ route('organization.projects.index') }}" wire:navigate class="btn btn-primary"><i data-feather="arrow-right"></i> @lang('site.next')</a>
                                    </div>
