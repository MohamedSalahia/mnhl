<form method="post" action="{{ route('organization.students.store_extra_project_enrollment', $student->hash_id) }}" class="ajax-form">
    @csrf
    @method('post')
    ...
    <div class="form-group mb-0">
        <button type="submit" class="btn btn-primary btn-block">
            <i data-feather="plus"></i> @lang('students.extra_project_enrollment_submit')
        </button>
    </div>
