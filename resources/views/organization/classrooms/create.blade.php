                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('organization.classrooms.store') }}" class="ajax-form">
                                @csrf
                                @method('post')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="start_date" class="form-control date-picker" value="{{ old('start_date') }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="end_date" class="form-control date-picker" value="{{ old('end_date') }}" required>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" class="form-control select2" required>
                                        ...
                                        <option value="{{ ClassroomTypeEnum::INDIVIDUAL }}" {{ old('type') == ClassroomTypeEnum::INDIVIDUAL ? 'selected' : '' }}>
                                            @lang('classrooms.individual')
                                        </option>
                                        <option value="{{ ClassroomTypeEnum::GROUP }}" {{ old('type') == ClassroomTypeEnum::GROUP ? 'selected' : '' }}>
