                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('organization.currencies.update', $currency->id) }}" class="ajax-form">
                                @csrf
                                @method('put')
                                        ...
                                        <div class="col-md-{{ $activeLanguages->count() == 2 ? '6' : '12' }}">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="{{ $activeLanguage->code }}[name]" data-error-name="{{ $activeLanguage->code }}.name"
                                                       class="form-control"
                                                       value="{{ old($activeLanguage->code . '.name', $currency->translate($activeLanguage->code)?->name) }}"
                                        ...
                                        <div class="col-md-{{ $activeLanguages->count() == 2 ? '6' : '12' }}">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="{{ $activeLanguage->code }}[code]" data-error-name="{{ $activeLanguage->code }}.code"
                                                       class="form-control"
                                                       value="{{ old($activeLanguage->code . '.code', $currency->translate($activeLanguage->code)?->code) }}"
                                                       {{ $activeLanguage->code === 'ar' ? 'required' : '' }}
                                                       autocomplete="off"
                                                >
                                            </div>
