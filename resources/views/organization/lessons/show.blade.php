                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{ route('organization.lessons.index') }}">@lang('lessons.lessons')</a>
                                </li>
                            ...
                            <div class="hero-stats">
                                ...
                                @if($lesson->branch)
                                    <div class="hero-stat-card">
                                        ...
                                        <div class="stat-content">
                                            <div class="stat-value">{{ $lesson->branch->name }}</div>
                                ...
                                @if($lesson->teacher)
                                    <div class="hero-stat-card">
                                        ...
                                        <div class="stat-content">
                                            <div class="stat-value">{{ $lesson->teacher->name }}</div>
                                            <div class="stat-label">@lang('teachers.teacher')</div>
                                        </div>
                                    </div>
                                @endif
                        ...
                        <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2">
                                @if($lesson->time_elapsed !== null)
                                    <a href="{{ route('organization.lessons.download_report', $lesson) }}" class="btn btn-success" target="_blank">
                                        <i data-feather="file-text"></i>
                                        @lang('lessons.create_report')
                                    </a>
                                @else
                                    <button type="button" class="btn btn-success" disabled style="opacity: 0.5; cursor: not-allowed;" title="@lang('lessons.time_elapsed_required')">
                                        <i data-feather="file-text"></i>
                                        @lang('lessons.create_report')
                                    </button>
                                @endif
