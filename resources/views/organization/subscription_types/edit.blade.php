                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('organization.subscription_types.update', $subscriptionType->id) }}" class="ajax-form">
                                @csrf
                                @method('put')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="year" data-error-name="year" class="form-control"
                                           value="{{ old('year', $subscriptionType->year) }}" min="1900" max="2100" required autofocus>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" data-error-name="name"
                                           class="form-control"
                                           value="{{ old('name', $subscriptionType->name) }}"
                                           required
                                    >
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="fees" data-error-name="fees" class="form-control" value="{{ old('fees', $subscriptionType->fees) }}" step="0.01" min="0" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="currency_id" class="form-control select2">
                                        ...
                                        @foreach($currencies as $currency)
                                            <option value="{{ $currency->id }}" {{ old('currency_id', $subscriptionType->currency_id) == $currency->id ? 'selected' : '' }}>
                                                {{ $currency->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" name="has_specific_date" value="1" id="has_specific_date"
                                            {{ old('has_specific_date', $subscriptionType->has_specific_date) ? 'checked' : '' }}>
                                ...
                                <div class="row" id="subscription-type-dates">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="start_date" data-error-name="start_date" class="form-control date-picker"
                                                   value="{{ old('start_date', $subscriptionType->start_date?->format('Y-m-d')) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="end_date" data-error-name="end_date" class="form-control date-picker"
                                                   value="{{ old('end_date', $subscriptionType->end_date?->format('Y-m-d')) }}">
                                        </div>
                                    </div>
