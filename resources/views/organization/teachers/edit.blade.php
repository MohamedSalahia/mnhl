                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('organization.teachers.update', $teacher->id) }}" class="ajax-form" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" class="form-control" autofocus value="{{ old('name', $teacher->name) }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="gender" class="form-control select2" required>
                                                ...
                                                <option value="male" {{ old('gender', $teacher->gender) == 'male' ? 'selected' : '' }}>@lang('users.male')</option>
                                                <option value="female" {{ old('gender', $teacher->gender) == 'female' ? 'selected' : '' }}>@lang('users.female')</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="tel" name="mobile" class="form-control intl-tel" value="{{ old('mobile', $teacher->mobile) }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="date_of_birth" class="form-control date-picker" value="{{ old('date_of_birth', $teacher->date_of_birth) }}" required>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="marital_status" class="form-control select2" required>
                                                ...
                                                @foreach (MaritalStatusEnum::getConstants() as $maritalStatus)
                                                    <option value="{{ $maritalStatus }}" {{ old('marital_status', $teacher->marital_status) == $maritalStatus ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="nationality_id" class="form-control select2" required>
                                                ...
                                                @foreach($nationalities as $nationality)
                                                    <option value="{{ $nationality->id }}" {{ old('nationality_id', $teacher->nationality_id) == $nationality->id ? 'selected' : '' }}>
                                                        {{ $nationality->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="mt-1">
                                                @if($teacher->image)
                                                    <img class="uploaded-image" src="{{ $teacher->image_path }}" style="display:block; width: 100px; border-radius: 50%;">
                                                @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="mt-1">
                                                @if($teacher->identity_document_file)
                                                    <img class="uploaded-image" src="{{ $teacher->identity_document_file_path }}" style="display: block; width: 100px;">
                                                @else
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="current_address" class="form-control" value="{{ old('current_address', $teacher->current_address) }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="last_educational_certificate" class="form-control" value="{{ old('last_educational_certificate', $teacher->last_educational_certificate) }}">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="teacher_certificate_ids" id="teacher-certificate-ids" value="{{ json_encode($teacher->teacherCertificates->pluck('id')->toArray()) }}">

                                    <div class="row assets-wrapper">

                                        @foreach($teacher->teacherCertificates as $certificate)
                                            @php
                                                $objectFit = $certificate->type === 'image' ? 'cover' : 'contain';
                                            @endphp
                                            <div class="col-md-3 single-asset" style="margin: 10px 0;" id="{{ $certificate->id }}">
                                                <div class="asset-container" style="border: 1px solid #D8D6DE; border-radius: 6px; padding: 10px;">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div style="position: relative; width: 100%; height: 150px;">
                                                                <img src="{{ $certificate->preview_path }}" class="img-fluid" style="width: 100%; height: 150px; object-fit: {{ $objectFit }}; border-radius: 6px;"/>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12 d-flex align-self-center justify-content-end mt-1">
                                                            <button class="btn btn-danger btn-sm delete-asset-btn btn-block" data-delete-asset-id="{{ $certificate->id }}" data-delete-url="{{ route('organization.assets.destroy', $certificate->id) }}"><i data-feather="trash"></i></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
