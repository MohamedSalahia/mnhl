                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="{{ route('examiner.home') }}">@lang('site.home')</a>
                                </li>
                                <li class="breadcrumb-item">
                                    @php
                                        $statusLabels = [
                                    ...
                                    @endphp
                                    <a href="{{ route('examiner.assessments.index', ['status' => $assessment->status]) }}">{{ $breadcrumbLabel }}</a>
                                </li>
                                        ...
                                        @if(in_array($assessment->status, [AssessmentStatusEnum::PENDING, AssessmentStatusEnum::IN_PROGRESS, AssessmentStatusEnum::PARTIALLY_IN_PROGRESS]))
                                            @php
                                                ...
                                                $buttonRoute = $assessment->status === AssessmentStatusEnum::PENDING
                                                    ? route('examiner.assessments.start', $assessment->id)
                                                    : route('examiner.assessments.resume', $assessment->id);
                                            @endphp
